...
# Orden de columnas en `export_excel.HEADERS` y en la hoja de revisión del runner local.
PRESTO_HEADER_CODES: tuple[str, ...] = ("Código", "Nat", "Ud", "Resumen", "CanPres", "PrPres", "ImpPres")
