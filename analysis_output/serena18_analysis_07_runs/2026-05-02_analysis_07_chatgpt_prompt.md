# Prompt para ChatGPT - analysis_07 - SERENA 18
...
Corridas incluidas:
- analysis_07_NPT_P1 | status=completed | scheduled_pairs=2 | primary_incidents=53 | defendable_incidents=6 | validation_incidents=47 | debug_conflicts=179
...
- analysis_07_NPT_P2 | status=completed | scheduled_pairs=3 | primary_incidents=66 | defendable_incidents=46 | validation_incidents=20 | debug_conflicts=769
...
- analysis_07_CIMENTACION | status=completed | scheduled_pairs=2 | primary_incidents=1 | defendable_incidents=1 | validation_incidents=0 | debug_conflicts=706
...
- analysis_07_SOTANO | status=completed | scheduled_pairs=2 | primary_incidents=0 | defendable_incidents=0 | validation_incidents=0 | debug_conflicts=429
- analysis_07_TECHO | status=completed | scheduled_pairs=6 | primary_incidents=157 | defendable_incidents=131 | validation_incidents=26 | debug_conflicts=1262
...
- analysis_07_ARQ_HS_P1 | status=completed | scheduled_pairs=1 | primary_incidents=0 | defendable_incidents=0 | validation_incidents=0 | debug_conflicts=66
