...
- Status: `completed`
- Generated: `2026-05-02T13:10:59.591252+00:00`

## Executive Summary
- Scheduled pairs reviewed: `1` across `2` source files.
- Defendable findings today: `0` of `0` primary incidents.
- Technical noise held outside the main report: `66` debug conflicts and `167` suppressed elements.
...
- Debug conflicts kept outside the executive list: `66`.
- Suppressed geometry count: `167`; main reasons: container_bbox=155, bounds_fallback=12.
- Audit status mix: eligible=2.
