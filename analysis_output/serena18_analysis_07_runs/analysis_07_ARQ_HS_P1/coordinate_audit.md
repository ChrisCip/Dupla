...
| --- | --- | --- | --- | --- | ---: | ---: | --- |
| `2208-Serena18-ID-Base.dwg` | ARQUITECTURA | `NPT_P1` | `eligible` | `X~1.61M, Y~1.91M` | 1385 | 29 | - |
| `5.7.2025 SERENA 18 PLANOS AS-BUILT.dwg` | FONTANERIA | `NPT_P1` | `eligible` | `X~1.61M, Y~1.91M` | 194760 | 300 | - |
