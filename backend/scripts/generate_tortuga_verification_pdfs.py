...
Run with Dupla repo mounted at /dupla:
  docker compose run --rm --no-deps -v "/path/to/Dupla:/dupla:ro" --entrypoint python backend scripts/generate_tortuga_verification_pdfs.py
"""
