    ...
    <Card data-tour="workspace-archivos-root" className="flex min-h-0 w-full flex-1 flex-col gap-4 p-6">
      <div className="shrink-0">
        ...
        <p className="mt-1 text-xs text-muted">
          Sugerido para coordinación: carpeta de entrega (ej. TEST_01) con planos .dwg etiquetados por disciplina
          (arquitectura, estructura), o subcarpetas REV / ARQUITECTURA y REV / ESTRUCTURAL.
        </p>
        {fileNotice ? (
