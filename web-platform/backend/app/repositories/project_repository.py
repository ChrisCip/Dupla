...
from app.domain.coordination_profile import infer_profile_from_project_fields
...
class ProjectRepository:
    ...
    async def create_with_architecture(
        ...
        *,
        ...
        loc = loc or None
        coord_profile = infer_profile_from_project_fields(name=name, project_code=pc)
        project = Project(
            name=name,
            ...
            project_code=pc,
            coordination_profile=coord_profile,
            location_text=loc,
