    ...
    def __init__(self) -> None:
        self.config = DisciplineConfig(
            ...
            item_types={
                ...
                "wet_area_count", "wet_area_area",
                "kitchen_count", "kitchen_area",
                "stair_count", "fixture_count",
                "structural_count", "structural_length", "structural_area",
                "structural_volume",
                "beam_concrete_volume", "beam_length", "beam_area",
                "beam_formwork_area_hint", "beam_reinforcement_kg",
                "column_concrete_volume", "column_length", "column_area",
                "column_formwork_area_hint", "column_reinforcement_kg",
                "slab_concrete_volume", "slab_area",
                "slab_formwork_area_hint", "slab_reinforcement_kg",
                "footing_concrete_volume", "footing_area",
                "footing_formwork_area_hint", "footing_reinforcement_kg",
            },
            bc3_chapter_filter={"01", "02", "03", "04", "05", "06", "07", "08", "09"},
        )
